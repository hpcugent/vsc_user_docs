...
You \OS can look at your public/private key pair as a lock and a key: you give us
...
you can use the \texttt{env} command. You can sort this output with \texttt{sort}
...
You can also use the \texttt{grep} command to search for a piece of text. The
...
The \texttt{-e} option will result in the script getting stopped if any command fails.

The \texttt{-u} option will result in the script getting stopped if empty variables are used.
