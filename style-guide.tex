...
\texttt{includesite} command. Note: This command does not fail, but this can be
seen as a feature, since you need not worry about other sites.
...
\begin{verbatim}
you can connec to \loginnode with ssh.
\end{verbatim}

These macros are all defined inside \texttt{macros.tex}. You can define new macros like so:
\begin{verbatim}
\macro{\city}{Gent}
\end{verbatim}
