...
chapter a meaningful filename. For example: \texttt{ch_introduction.tex}.
...
If large pieces of text need to be included you can use the \texttt{includesite} command.
