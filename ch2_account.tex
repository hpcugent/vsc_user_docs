...
use for Webmail, \dots ), you will be asked to upload the file that contains
...
\ifwindows
  ...
  \begin{enumerate}
    ...
    \item  Within the category $<$\textbf{\textit{Session}}$>$, in the field
      ...
      \hpc cluster (i.e., ``\textbf{\textit{\loginnode}}'')
...
\begin{enumerate}
  ...
  \item  \textit{``\loginnode''} is the name of the login
