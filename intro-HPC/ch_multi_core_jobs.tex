...
\begin{prompt}
%\shellcmd{cd ./examples/Chapter07\_Parallel/Thread}%
\end{prompt}

Study the example first:

% TODO: maybe instead of cat use a proper listing for C code?
\begin{prompt}
%\shellcmd{cat T\_hello.c}%
#include <stdio.h>
#include <stdlib.h>
#include <pthread.h>
#define NTHREADS 7
...
int main(int argc, char *argv[])
{
  ...
  %\strong{/* wait for threads to finish */}%
  for (i=0; i<NTHREADS; ++i) \{
...
\begin{prompt}
%\shellcmd{cd \tilde/examples/Chapter07\_Parallel/OMP}%
\end{prompt}
...
\begin{prompt}
%\shellcmd{cd \tilde/examples/Chapter07\_Parallel/MPI}%
\end{prompt}
...
\begin{prompt}
%\shellcmd{more mpi\_hello.c}%
%\dots%
%\shellcmd{more mpi\_hello.pbs}%
#!/bin/bash
#PBS -N mpi_hello
#PBS -q qshort
