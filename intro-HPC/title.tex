...
(\url{https://www.vscentrum.be}) will serve as a reference for all the \hpc
operations.
...
\begin{enumerate}
  ...
  \ifantwerpen
    \item CalcUA Core Facility web pages: \url{https://www.uantwerpen.be/en/research-and-innovation/research-at-uantwerp/core-facilities/core-facilities/calcua/}
  \fi
  \ifbrussel
