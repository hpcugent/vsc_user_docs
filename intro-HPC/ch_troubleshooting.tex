...
If you're using PuTTY and get this errormessage:

\begin{prompt}
server unexpectedly closed network connection
\end{prompt}

it can be because your PuTTY version is too old. Make sure you're using at least
version 0.70. If your PuTTY version is too old, you can uninstall it and then
install the latest version. See \autoref{sec:install-putty} for how to do this.
