...
example, we try to load both the \verb|intel-2018a| and \verb|intel-2017a|
module:
...
Use 'ml spider HMMER' to get an overview of the available versions.
...
a module with \verb|module spider|: for \verb|HMMER|, this command is \verb|module spider HMMER|.
\fi
