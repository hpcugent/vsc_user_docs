...
\begin{enumerate}
            ...
            \item Use \verb|ssh-add|:
                ...
                \fi\emph{OR;}
            \item Specify the location of the key in \verb|~/.ssh/config|. You will
                need to replace the VSC login id with your own:
...
\fi
        ...
        \item You previously connected to the \hpc from another machine, but now
            ...
            for 15-20 minutes until your new keys become active.
...
If you've tried all applicable items above, please contact \hpcinfo and include the
