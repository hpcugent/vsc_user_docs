...
\begin{enumerate}
    ...
    \includegraphics*[width=4.71in, height=4.60in, keepaspectratio=false]{8.3.1.change01}
    \item Then click \keys{Load} button
    \includegraphics*[width=4.71in, height=4.60in, keepaspectratio=false]{8.3.1.change02}
    \item Expand SSH category (on the left panel) clicking on the \keys{+} next to SSH
    \includegraphics*[width=4.71in, height=4.60in, keepaspectratio=false]{8.3.1.change03}
    \item \label{item:putty-auth-ssh} Click on Auth under the SSH category
    \includegraphics*[width=4.71in, height=4.60in, keepaspectratio=false]{8.3.1.change04}
    \item On the right panel, click \keys{Browse} button
    \includegraphics*[width=4.71in, height=4.60in, keepaspectratio=false]{8.3.1.change05}
    ...
    \includegraphics*[width=4.71in, height=4.60in, keepaspectratio=false]{8.3.1.change06}
    \item On the right panel, click on \keys{Save} button
    \includegraphics*[width=4.71in, height=4.60in, keepaspectratio=false]{8.3.1.change07}
\end{enumerate}
...
\begin{enumerate}
    ...
    \includegraphics*[width=4.71in, height=4.60in, keepaspectratio=false]{8.3.2.check05}
    \item Open PuTTYgen
    \includegraphics*[width=4.71in, height=4.60in, keepaspectratio=false]{8.3.2.check06}
    \item Enter menu item "Filei" and select "Load Private key"
    \includegraphics*[width=4.71in, height=4.60in, keepaspectratio=false]{8.3.2.check07}
    \item On the "Load private key" popup, click in the textbox next to "File name:", then paste the location of
        your private key (push \keys{Ctrl} + \keys{v})
    \includegraphics*[width=7.88in, height=4.44in, keepaspectratio=false]{8.3.2.check08}
    \item Make sure that your Public key from the "Public key for pasting into OpenSSH authorized\_keys file"
        textbox is in your Publickesy session on the accountpage \url{https://account.vscentrum.be}.
        (Scroll down to the bottom of "View Account" tab, you will find there the "Public keys" section)
    \includegraphics*[width=4.71in, height=4.60in, keepaspectratio=false]{8.3.2.check09}
\end{enumerate}
