...
results in \verb|ssh| ``forgetting'' the system you're connecting to.
...
that someone is trying to intercept the connection between you and the system you're connecting to.
Another possibility is that the host keys of the system you're connecting to have changed.
