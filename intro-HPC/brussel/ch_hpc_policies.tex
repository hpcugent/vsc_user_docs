...
\item  \strong{UPDATE THIS} a ``\emph{Fairshare}'' window of 7 days with a target of 12\%: the priority of jobs of a user who has used too many resources over the current ``\emph{Fairshare}'' window is lowered.
\end{enumerate}
...
fair share of the VUB-HPC utilization.  The mechanism incorporates historical
