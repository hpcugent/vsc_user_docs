...
\end{prompt}
\ifgent
We will also make a doc directory in your home dir and copy the latest version of this document to this directory.
\begin{prompt}
...
%  terminal window using the shortcut \keys{command}\keys{N}.
  ...
  Open your filebrowser  and press
  ...
  This should open up a url bar. Alternatively, look for the 'connect to server' option in your file browsers menu.
...
latter version, rather than the one that was intended, which may lead to unexpected
problems.
