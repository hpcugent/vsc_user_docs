...
If you previously saved your private key in the non default location (.ssh/id_rsa) you can get the error message
In this case use:
\begin{prompt}
%\shellcmd{ssh -i <path/to/location/of/private/key \userid{}@\loginnode{}}%
\end{prompt}
