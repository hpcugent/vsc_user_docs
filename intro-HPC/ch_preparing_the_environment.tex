...
\fi
    ...
    \item If this is your first time connecting, you will be asked to verify the authenticity of
        the login node. Please see ~\ref{sec:warning-message-new-host} on how to do this.
...
\end{prompt}
  ...
  verify the authenticity of the login node. Please check ~\ref{sec:warning-message-new-host}
  on how to do this.
