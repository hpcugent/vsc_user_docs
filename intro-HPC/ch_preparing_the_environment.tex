...
%% Question from Kurt L: Shouldn't this be in a \ifmacORlinux? On Windows it only holds in cygwin and so.
...
\ifmacORlinux
  ...
  The \strong{scp} command can also bu used to copy files from the cluster to your local machine.
  ...
  If you prefer a GUI to transfer files back and forth to the \hpc, we can
