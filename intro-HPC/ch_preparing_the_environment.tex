...
By default you are working on delcatty. To switch to, e.g., raichu you need
...
so your jobs will start on raichu instead of the default delcatty cluster.
...
have the same architecture as the delcatty cluster however, so this is why
