...
\ifmac
You can open a terminal by navigationg to Applications and then Utilities in the finder, or enter Terminal in spotlight and select Terminal.app
\fi
...
day (MOTD)
\begin{prompt}
Last login: Thu Nov  6 16:05:21 2014 from exile.ugent.be
...
\begin{prompt}
Last login: Mon Jan 12 18:52:20 2015 from gligar01.ugent.be
**********************************************
*                                            *
...
This will switch the cluster you submit your jobs to (with qsub) to raichu
and only show you modules that are installed on raichu when you run
``module av''.
\fi
...
module-whatis  A collection of scripts to ease cluster usage. - Homepage: https://hpc.ugent.be/userwiki/index.php/Main_Page
conflict       scripts
...
- Module Specific Help for 'zlib/1.2.8-intel-2014b' -
