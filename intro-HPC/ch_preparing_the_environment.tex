...
\ifmacORlinux
  ...
  if you have symlinks to them in your homedirectory. See
...
\end{prompt}
  ...
  forget the colon at the end: if you forget it, it will just create a file
  named \texttt{\userid{}@\loginnode{}} on your local filesystem. You can even
  specify where to save the file by putting a path after the colon.
