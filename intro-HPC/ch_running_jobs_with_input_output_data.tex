...
\$VSC\_SCRATCH\_PHANPY  & The scratch filesystem on phanpy. Since phanpy has SSDs, this is faster than other scratch filesystems.\\ \hline
\fi
\end{tabular}
...
\verb|$VSC_DATA_VO/$USER|), and analogous for \verb|$VSC_SCRATCH_VO_USER|.
