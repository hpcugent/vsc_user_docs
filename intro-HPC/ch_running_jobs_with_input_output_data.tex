...
You should specify your whole username - tab completion will not work.


If you want to use the UGent shares longer than 24hours,
...
To simply renew your tickets, run
...
Each hour the process will check if you ticket should be renewed.
