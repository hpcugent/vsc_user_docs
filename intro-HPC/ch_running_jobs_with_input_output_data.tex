...
In order to access your UGent home and shares inside the globus access point, you'll first have to authenticate. To do this, you have to ssh to the globus endpoint from a loginnode. You will be prompted for your UGent username and password to authenticate:

\begin{prompt}
%\shellcmd{ssh globus01}%
...
Your shares will then be available at /UGent/ugentusername/ under the globus VSC tier2 endpoint. Tickets will be renewed automatically for 1 week, after which you'll need to run this again. If you want to disable access to your shares within globus, you have to run

\begin{prompt}
%\shellcmd{ssh globus01 destroy}%
