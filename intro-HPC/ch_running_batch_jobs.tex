...
example, to list the available versions of the GSL library:

\begin{prompt}
%\shellcmd{module avail GSL}%
FGSL/1.1.0-intel-2016b (D)    GSL/2.3-intel-2016b
GSL/2.1-intel-2016b           GSL/2.3-intel-2017a
GSL/2.2.1-intel-2016b         GSL/2.4-GCCcore-6.4.0 (D)
GSL/2.3-foss-2016b
