...
\begin{itemize}
    ...
    \item Whether or not you are a member of a \emph{Virtual Organisation} (VO).

        Each VO gets assigned a \emph{fair share target}, which has a big impact
        ...
        See section~\autoref{sec:virtual-organisations} for more information on how to join a VO,
        or request the creation of a new VO if there is none yet for your research group.
