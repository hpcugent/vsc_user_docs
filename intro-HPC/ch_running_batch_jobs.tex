...
To use other clusters, you can swap the \verb|cluster| modules.
...
The \othercluster modules may not work directly on the login nodes, because the
...
all depend on which cluster module is loaded.
\fi
