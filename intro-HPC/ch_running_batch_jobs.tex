...
\begin{prompt}
%\shellcmd{qsub -m abe -M john.smith@example.com fibo.pbs}%
\end{prompt}

In these examples, we specified the e-mail address as ``john.smith@example.com'',
but don't have to specify the e-mail address: if you don't specify it, the system will
use the e-mail address that is connected to your VSC account.
