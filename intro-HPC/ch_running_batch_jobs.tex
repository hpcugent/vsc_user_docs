...
\section{Getting system information about the cluster}

\subsection{Checking the general status of the cluster}
...
Here, there are 361 jobs running on the ``long'' queue, and 77 jobs queued. We
can also see that the ``long'' queue allows a maximum wall time of 72 hours.
...
You can also get this information with a command: \lstinline|pbsmon|:

\begin{prompt}
%\shellcmd{module swap cluster/phanpy}%
%\shellcmd{pbsmon}%
...
currently loaded \lstinline|cluster| module.
