...
All HPC-UGent shared filesystems will be readily available in an Apptainer/Singularity container,
...
\begin{prompt}
%\shellcmd{APPTAINER\_CACHEDIR=/tmp/ \textbackslash{}}%
%\textbf{APPTAINER\_TMPDIR=/tmp/ \textbackslash{}}%
%\textbf{apptainer build -{}-fakeroot /tmp/tensorflow-21.10-tf1-py3.sif \textbackslash{}}%
%\textbf{docker:{}//nvcr.io/nvidia/tensorflow:21.10-tf1-py3}%
\end{prompt}
