...
\ifgent
\strog{Note:} If you try to set on a UGent HPC cluster a non-supported locale,
then it will be automatically set to the default. Currently the default is
\lstinline|en_US.UFT-8| or \lstinline|en_US|, depending on whether your originally (non-supported)
locale was \lstinline|UTF-8| or not.
\fi
