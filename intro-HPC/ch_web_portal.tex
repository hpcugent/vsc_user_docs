\chapter{Using the HPC-UGent web portal}\label{ch:ood}

\href{https://openondemand.org/}{\strong{Open OnDemand}} (or \texttt{OoD} for short)
...
but there may be a couple of small problems that we still need to resolve.}

\strong{If you notice anything that doesn't work as expected or could be improved,
please contact \hpcinfo.}

\strong{In addition, you \emph{must} be connected to the HPC-UGent network
...
\strong{Do keep in mind that desktop environments on a cluster workernode are limited a maximum of
...
\begin{center}
    \includegraphics*[scale=0.35]{ood_desktop_running}
\end{center}
