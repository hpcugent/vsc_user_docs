...
\begin{prompt}
%\shellcmd{cd \tilde/examples/Chapter0\arabic{chapter}\_Files}%
\end{prompt}
...
\textit{\underbar{Tip}: Find the code of the exercises in ``\tilde/examples/Chapter0\arabic{chapter}\_Files''}
...
``\tilde/examples/Chapter0arabic{chapter}\_Files''}.
