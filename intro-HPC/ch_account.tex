...
\fi %ifwindows
 ...
 \item Upload the new SSH public key using the \strong{Add public key} section. Make sure that your public key is actually saved, becasue a public key will be refused if it is too short, wrong type, or in a wrong format.
