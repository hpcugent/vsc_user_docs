...
\ifbrussel
 ...
 the Flemish Supercomputing Center (VSC), then you have to apply for a VSC account.
\fi
...
\ifwindows
  ...
  keys. You need 2 keys, a public and a private key. You can visualize the public
...
where you have to select your ``Home Organization''.
...
\ifwindows
  ...
  \includegraphics*[width=3.94in, height=2.47in, keepaspectratio=false]{ch2-putty-enter-password}
    ...
    \item  The first time you make a connection to the loginnode, a Security
      ...
      \fi
      \ifbrussel
      Make sure the fingerprint in the Alert matches \strong{41:68:9b:c2:f0:1c:d3:62:14:b6:71:f0:36:8a:7d:ec}
      \fi
...
%TODO: verify that these are the correct directories
