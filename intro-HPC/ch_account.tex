...
%\shellcmd{ls -l}%
total 256
lrwxrwxrwx 1 %\userid \userid% 25 Nov 13 09:53 tutorials -> /apps/%\sitename%/tutorials/
...
%\shellcmd{ls -l}%
total 792
drwxrwxr-x 10 %\userid% %\userid% 131072 Nov  4 13:15 examples/
lrwxrwxrwx 1  root     root         25 Nov 12 14:51 tutorials -%$>$% /apps/%\sitename%/tutorials/
\end{prompt}
