...
\end{prompt}
  ...
  your operating system requires this. Be aware that your existing key pair might
  be too short, or not the right type.
  ...
  \begin{enumerate}
    ...
    \item  your key pair is too short or not the right type
  \end{enumerate}
...
\begin{prompt}
%\shellcmd{ssh-keygen -t rsa -b 4096}%
...
generated earlier. Make sure that your public key is actually accepted
for upload, beacuse if it is in a wrong format, wrong type or too short,
then it will be refused.
...
\fi %ifwindows
 ...
 \item Upload the new SSH public key using the \strong{Add public key} section.
   Make sure that your public key is actually saved, because a public key will be refused 
