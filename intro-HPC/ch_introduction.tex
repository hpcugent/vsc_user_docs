...
%    \item  2 nodes with 2 10-core Haswell Xeon E5-2650v3 processors, 128 GB memory, 
%           300 GB local disk, DDR-IB network, 2 NVIDIA Quadro K5200 GPUs (visualization nodes)
%    \item  64 sockets with 10-core Xeon E5-4650 processors, total 14 TB memory, SGI-proprietary NUMAlink6 interconnect, 
%           1 partition has 480 cores and 12 TB RAM and another partition has 160 cores and 2 TB RAM, 
%           both partitions have 10TB local scratch space (Cerebro - shared memory SMP section)
  \end{enumerate}
\fi
\ifbrussel
  \begin{enumerate}
...
\item{in chemistry: Gaussian, GROMACS, Molpro, NAMD, NWChem, Siesta, Turbomole, VMD,}
\item{in engineering: Abaqus, Ansys, Comsol,}
