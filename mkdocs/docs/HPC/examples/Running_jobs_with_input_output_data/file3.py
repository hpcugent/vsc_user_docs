...
# Description: Example showing a write (step#1) and subsequent read (=step#2)
#              operation in the SCRATCH directory
"""
...
filename_p1 = f"{scratch_dir or '.'}/primes_1.txt"
filename_p2 = f"{scratch_dir or '.'}/primes_2.txt"

with (
    open(filename_p1, "r", encoding="utf-8") as f_in,
    open(filename_p2, "w", encoding="utf-8") as f_out,
):
    print(f"Input File: {filename_p1}")
    print(f"Output File: {filename_p2}")
