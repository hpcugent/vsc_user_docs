...
```shell
module load lxml/6.1.1-GCCcore-15.2.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|lxml/6.1.1-GCCcore-15.2.0|x|x|x|x|x|x|x|x|
|lxml/6.0.0-GCCcore-14.3.0|x|x|x|x|x|x|x|x|
|lxml/5.3.0-GCCcore-14.2.0|x|x|x|x|x|x|x|x|
