...
```shell
module load Bison/3.8.2-GCCcore-15.2.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|Bison/3.8.2-GCCcore-15.2.0|x|x|x|x|x|x|x|x|
|Bison/3.8.2-GCCcore-14.3.0|x|x|x|x|x|x|x|x|
|Bison/3.8.2-GCCcore-14.2.0|x|x|x|x|x|x|x|x|
