...
```shell
module load parameterized/0.9.0-GCCcore-14.3.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|parameterized/0.9.0-GCCcore-14.3.0|x|x|x|x|x|x|x|x|
|parameterized/0.9.0-GCCcore-13.3.0|x|x|x|x|x|x|x|x|
|parameterized/0.9.0-GCCcore-12.3.0|x|x|x|x|x|x|x|x|
