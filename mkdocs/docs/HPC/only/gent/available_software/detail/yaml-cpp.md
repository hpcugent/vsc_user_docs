...
```shell
module load yaml-cpp/0.8.0-GCCcore-14.2.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|yaml-cpp/0.8.0-GCCcore-14.2.0|x|x|x|x|x|x|x|x|
|yaml-cpp/0.8.0-GCCcore-13.3.0|x|x|x|x|x|x|x|x|
|yaml-cpp/0.8.0-GCCcore-13.2.0|-|x|x|x|x|x|x|x|
