...
```shell
module load gmpy2/2.3.0-GCCcore-15.2.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|gmpy2/2.3.0-GCCcore-15.2.0|x|x|x|x|x|x|x|x|
|gmpy2/2.2.0-GCCcore-14.3.0|x|x|x|x|x|x|x|x|
|gmpy2/2.2.0-GCCcore-14.2.0|x|x|x|x|x|x|x|x|
|gmpy2/2.2.0-GCCcore-13.3.0|x|x|x|x|x|x|x|x|
