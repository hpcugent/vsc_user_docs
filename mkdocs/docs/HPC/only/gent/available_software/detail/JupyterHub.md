...
```shell
module load JupyterHub/5.5.0-GCCcore-15.2.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|JupyterHub/5.5.0-GCCcore-15.2.0|x|x|x|x|x|x|x|x|
|JupyterHub/4.1.5-GCCcore-13.2.0|x|x|x|x|x|x|x|x|
|JupyterHub/4.0.2-GCCcore-12.3.0|x|x|x|x|x|x|x|x|
