...
```shell
module load GLPK/5.0-GCCcore-14.3.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|GLPK/5.0-GCCcore-14.3.0|x|x|x|x|x|x|x|x|
|GLPK/5.0-GCCcore-14.2.0|x|x|x|x|x|x|x|x|
|GLPK/5.0-GCCcore-13.3.0|x|x|x|x|x|x|x|x|
|GLPK/5.0-GCCcore-13.2.0|x|x|x|x|x|x|x|x|
|GLPK/5.0-GCCcore-12.3.0|x|x|x|x|x|x|x|x|
|GLPK/5.0-GCCcore-12.2.0|-|-|-|-|-|x|x|x|
|GLPK/5.0-GCCcore-11.3.0|-|-|-|-|-|x|x|x|
