...
The pymbar package contains the pymbar suite of tools for the analysis ofsimulated and experimental data with the multistate Bennett acceptanceratio (MBAR) estimator.

http://pymbar.readthedocs.io/en/master/
# Available modules
