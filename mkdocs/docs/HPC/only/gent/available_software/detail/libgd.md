...
```shell
module load libgd/2.3.3-GCCcore-14.3.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|libgd/2.3.3-GCCcore-14.3.0|x|x|x|x|x|x|x|x|
|libgd/2.3.3-GCCcore-14.2.0|x|x|x|x|x|x|x|x|
|libgd/2.3.3-GCCcore-13.3.0|x|x|x|x|x|x|x|x|
