...
```shell
module load configurable-http-proxy/5.2.0-GCCcore-15.2.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|configurable-http-proxy/5.2.0-GCCcore-15.2.0|x|x|x|x|x|x|x|x|
|configurable-http-proxy/4.6.1-GCCcore-13.2.0|x|x|x|x|x|x|x|x|
|configurable-http-proxy/4.5.6-GCCcore-12.3.0|x|x|x|x|x|x|x|x|
