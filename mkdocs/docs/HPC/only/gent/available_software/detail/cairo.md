...
```shell
module load cairo/1.18.4-GCCcore-14.3.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|cairo/1.18.4-GCCcore-14.3.0|x|x|x|x|x|x|x|x|
|cairo/1.18.4-GCCcore-14.2.0|x|x|x|x|x|x|x|x|
|cairo/1.18.0-GCCcore-13.3.0|x|x|x|x|x|x|x|x|
|cairo/1.18.0-GCCcore-13.2.0|x|x|x|x|x|x|x|x|
|cairo/1.17.8-GCCcore-12.3.0|x|x|x|x|x|x|x|x|
|cairo/1.17.4-GCCcore-12.2.0|-|-|-|-|-|x|x|x|
|cairo/1.17.4-GCCcore-11.3.0|-|-|-|-|-|x|x|x|
