...
```shell
module load wget/1.25.0-GCCcore-14.2.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|wget/1.25.0-GCCcore-14.2.0|x|x|x|x|x|x|x|x|
|wget/1.25.0-GCCcore-13.3.0|x|x|x|x|x|x|x|x|
|wget/1.24.5-GCCcore-13.2.0|x|x|x|x|x|x|x|x|
|wget/1.24.5-GCCcore-12.3.0|x|x|x|x|x|x|x|x|
