...
```shell
module load Automake/1.18.1-GCCcore-15.2.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|Automake/1.18.1-GCCcore-15.2.0|x|x|x|x|x|x|x|x|
|Automake/1.18.1|x|x|x|x|x|x|x|x|
|Automake/1.18-GCCcore-14.3.0|x|x|x|x|x|x|x|x|
|Automake/1.17-GCCcore-14.2.0|x|x|x|x|x|x|x|x|
