...
```shell
module load einops/0.8.1-GCCcore-13.3.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|einops/0.8.1-GCCcore-13.3.0|x|x|x|x|x|x|x|x|
|einops/0.8.0-GCCcore-13.2.0|x|x|x|x|x|x|x|x|
|einops/0.7.0-GCCcore-12.3.0|x|x|x|x|x|x|x|x|
