...
```shell
module load Brotli/1.1.0-GCCcore-14.3.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|Brotli/1.1.0-GCCcore-14.3.0|x|x|x|x|x|x|x|x|
|Brotli/1.1.0-GCCcore-14.2.0|x|x|x|x|x|x|x|x|
|Brotli/1.1.0-GCCcore-13.3.0|x|x|x|x|x|x|x|x|
|Brotli/1.1.0-GCCcore-13.2.0|x|x|x|x|x|x|x|x|
|Brotli/1.0.9-GCCcore-12.3.0|x|x|x|x|x|x|x|x|
|Brotli/1.0.9-GCCcore-12.2.0|-|-|-|-|-|x|x|x|
|Brotli/1.0.9-GCCcore-11.3.0|-|-|-|-|-|x|x|x|
