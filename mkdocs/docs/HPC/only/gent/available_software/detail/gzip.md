...
```shell
module load gzip/1.14-GCCcore-15.2.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|gzip/1.14-GCCcore-15.2.0|x|x|x|x|x|x|x|x|
|gzip/1.14-GCCcore-14.3.0|x|x|x|x|x|x|x|x|
|gzip/1.13-GCCcore-14.2.0|x|x|x|x|x|x|x|x|
