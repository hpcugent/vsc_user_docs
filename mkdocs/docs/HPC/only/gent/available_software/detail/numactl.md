...
```shell
module load numactl/2.0.19-GCCcore-15.2.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|numactl/2.0.19-GCCcore-15.2.0|x|x|x|x|x|x|x|x|
|numactl/2.0.19-GCCcore-14.3.0|x|x|x|x|x|x|x|x|
|numactl/2.0.19-GCCcore-14.2.0|x|x|x|x|x|x|x|x|
