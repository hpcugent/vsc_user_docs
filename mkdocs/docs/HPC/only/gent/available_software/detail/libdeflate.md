...
```shell
module load libdeflate/1.25-GCCcore-15.2.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|libdeflate/1.25-GCCcore-15.2.0|x|x|x|x|x|x|x|x|
|libdeflate/1.24-GCCcore-14.3.0|x|x|x|x|x|x|x|x|
|libdeflate/1.24-GCCcore-14.2.0|x|x|x|x|x|x|x|x|
|libdeflate/1.20-GCCcore-13.3.0|x|x|x|x|x|x|x|x|
|libdeflate/1.19-GCCcore-13.2.0|x|x|x|x|x|x|x|x|
|libdeflate/1.18-GCCcore-12.3.0|x|x|x|x|x|x|x|x|
|libdeflate/1.15-GCCcore-12.2.0|-|-|-|-|-|x|x|-|
|libdeflate/1.10-GCCcore-11.3.0|-|-|-|-|-|x|x|-|
