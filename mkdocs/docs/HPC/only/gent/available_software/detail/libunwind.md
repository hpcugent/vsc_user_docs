...
|libunwind/1.5.0-GCCcore-11.2.0|x|x|x|x|x|-|-|
|libunwind/1.4.0-GCCcore-10.3.0|x|x|x|x|x|-|-|
|libunwind/1.4.0-GCCcore-10.2.0|x|x|x|x|x|-|-|
|libunwind/1.3.1-GCCcore-9.3.0|-|x|x|-|x|-|-|
|libunwind/1.3.1-GCCcore-8.3.0|x|x|x|-|x|-|-|
