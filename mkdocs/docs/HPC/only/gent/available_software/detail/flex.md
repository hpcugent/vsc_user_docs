...
```shell
module load flex/2.6.4-GCCcore-15.2.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|flex/2.6.4-GCCcore-15.2.0|x|x|x|x|x|x|x|x|
|flex/2.6.4-GCCcore-14.3.0|x|x|x|x|x|x|x|x|
|flex/2.6.4-GCCcore-14.2.0|x|x|x|x|x|x|x|x|
