...
```shell
module load GMP/6.3.0-GCCcore-15.2.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|GMP/6.3.0-GCCcore-15.2.0|x|x|x|x|x|x|x|x|
|GMP/6.3.0-GCCcore-14.3.0|x|x|x|x|x|x|x|x|
|GMP/6.3.0-GCCcore-14.2.0|x|x|x|x|x|x|x|x|
