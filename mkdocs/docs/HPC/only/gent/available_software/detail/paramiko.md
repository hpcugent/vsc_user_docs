...
```shell
module load paramiko/4.0.0-GCCcore-14.3.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|paramiko/4.0.0-GCCcore-14.3.0|x|x|x|x|x|x|x|x|
|paramiko/3.5.1-GCCcore-13.3.0|x|x|x|x|x|x|x|x|
|paramiko/3.5.1-GCCcore-13.2.0|x|x|x|x|x|x|x|x|
|paramiko/3.2.0-GCCcore-12.3.0|x|x|x|x|x|x|x|x|
