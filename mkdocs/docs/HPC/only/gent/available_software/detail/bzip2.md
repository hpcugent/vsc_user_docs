...
```shell
module load bzip2/1.0.8-GCCcore-15.2.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|bzip2/1.0.8-GCCcore-15.2.0|x|x|x|x|x|x|x|x|
|bzip2/1.0.8-GCCcore-14.3.0|x|x|x|x|x|x|x|x|
|bzip2/1.0.8-GCCcore-14.2.0|x|x|x|x|x|x|x|x|
