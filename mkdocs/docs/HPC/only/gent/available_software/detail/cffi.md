...
```shell
module load cffi/2.0.0-GCCcore-15.2.0
```
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
|cffi/2.0.0-GCCcore-15.2.0|x|x|x|x|x|x|x|x|
|cffi/1.17.1-GCCcore-14.3.0|x|x|x|x|x|x|x|x|
|cffi/1.17.1-GCCcore-14.2.0|x|x|x|x|x|x|x|x|
