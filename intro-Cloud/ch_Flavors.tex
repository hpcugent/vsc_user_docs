...
VSC network gives an optimal path towards other VSC sites (ideal for
cloudbursting or for high perfomance connections between different clusters
and services within VSC).
