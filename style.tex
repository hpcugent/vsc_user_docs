...
\protected\def\til{\raise.17ex\hbox{$\scriptstyle\mathtt{\sim}$}}
\newcommand{\captureshellcmd}[1]{\StrSubstitute{#1}{~}{\string~}[\writeable]\immediate\write\shellcmds{\writeable > \Chaptername-\the\inputlineno.out}\StrSubstitute{#1}{~}{\noexpand\til}[\temp] \$ \textbf{\texttt{\temp}}}
