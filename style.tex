...
\lstnewenvironment{utf8prompt} {
    \leavevmode\\[-\baselineskip]
    \minipage{\linewidth}
    \lstset{
      style=prompt,literate=%
      {├}{{\mbox{\kern.23em\vrule height2.0exdepth0.8exwidth.4pt\vrule height2.0ptdepth-1.8ptwidth.23em}}}1
      {└}{{\mbox{\kern.23em\vrule height2.0exdepth-1.8ptwidth.4pt\vrule height2.0ptdepth-1.8ptwidth.23em}}}1
      {─}{{\mbox{\vrule height2.0ptdepth-1.8ptwidth.5em}}}1
    }
} {
   \endminipage
}
